  ...
  return (
    <div className='bg-primary py-10 px-6'>
        <div className='container mx-auto py-10 md:px-0 px-6'>
            ...
            <p className='text-white pt-2 text-center font-bold pb-6'>+254 757 435 210</p>
            <p className='text-white pt-2 text-center font-bold pb-6'>info@beyondmatrixltd.co.ke</p>
